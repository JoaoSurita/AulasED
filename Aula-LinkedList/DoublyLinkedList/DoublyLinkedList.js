class DoublyLinkedList {
    ...
    insertAt(value, index) {
        ...
        this.#length++;
        // (Em uma implementação completa, o return da função estaria aqui, geralmente retornando o newNode ou true)
    }
    ...
    removeAt(index) {
        ...
        // Desliga o nó 'current' (o nó a ser removido) da lista
